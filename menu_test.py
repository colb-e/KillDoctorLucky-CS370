...
rooms3.roomsList[0].room_count = 1
player1.updatePlayer(TEMP)
rooms3.roomsList[0].room_count = 2
player2.updatePlayer(TEMP)
rooms3.roomsList[0].room_count = 3
player3.updatePlayer(TEMP)
rooms3.roomsList[0].room_count = 4
...
def updateRoom(roomIndex):
    rooms3.roomsList[roomIndex].room_count = 0
    
    for player in playerList:
        if player.room_index == roomIndex:
            player.updatePlayer(roomIndex)
            rooms3.roomsList[roomIndex].room_count += 1
...
moveActionButton = button3.Button(screen, moveActionButtonImage, 1, 1000, sidebarScale)
moveActionButton.addToSidebar(board_W, 1, 7)

# Draw card Button
drawCardButtonImage = pygame.image.load("images/drawcardbutton.png")
drawCardButton = button3.Button(screen, drawCardButtonImage, 1, 1000, sidebarScale)
drawCardButton.addToSidebar(board_W, 1, 3.45)

# Cards button
cardsBtnImage = pygame.image.load("images/cardsbutton.png")
cardsButton = button3.Button(screen, cardsBtnImage, 1, 1000, sidebarScale)
cardsButton.addToSidebar(board_W, 1, 2.3)

# Kill Button
killBtnImage = pygame.image.load("images/KillButton.png")
killButton = button3.Button(screen, killBtnImage, 1, 1000, sidebarScale)
killButton.addToSidebar(board_W, 1, 1.73)

# Rules Button 
rulesBtnImage = pygame.image.load("images/rulesbutton.png")
rulesButton = button3.Button(screen, rulesBtnImage, 1, 1000, sidebarScale)
rulesButton.addToSidebar(board_W, 1, 1.38)

# Quit Button 
quitBtnImage = pygame.image.load("images/quitbutton.png")
quitButton = button3.Button(screen, quitBtnImage, 1, 1000, sidebarScale)
quitButton.addToSidebar(board_W, 1, 1.16)

# Room movement buttons
moveHereImage = pygame.image.load("images/MoveHereButton.png")
room1 = button3.Button(screen, moveHereImage, 2.15, 1.8, moveButtonScale)
room2 = button3.Button(screen, moveHereImage, 1.6, 1.8, moveButtonScale)
room3 = button3.Button(screen, moveHereImage, 1.57, 3, moveButtonScale)
room4 = button3.Button(screen, moveHereImage, 2.2, 3.2, moveButtonScale)
room5 = button3.Button(screen, moveHereImage, 3.7, 3, moveButtonScale)
room6 = button3.Button(screen, moveHereImage, 3.6, 1.75, moveButtonScale)
room7 = button3.Button(screen, moveHereImage, 3.55, 1.2, moveButtonScale)
room8 = button3.Button(screen, moveHereImage, 9, 1.1, moveButtonScale)
room9 = button3.Button(screen, moveHereImage, 11, 1.32, moveButtonScale)
room10 = button3.Button(screen, moveHereImage, 13, 1.75, moveButtonScale)
room11 = button3.Button(screen, moveHereImage, 9.6, 3.5, moveButtonScale)
room12 = button3.Button(screen, moveHereImage, 12, 16, moveButtonScale)
room13 = button3.Button(screen, moveHereImage, 3.5, 17, moveButtonScale)
room14 = button3.Button(screen, moveHereImage, 2.2, 25, moveButtonScale)
room15 = button3.Button(screen, moveHereImage, 2.2, 7.2, moveButtonScale)
room16 = button3.Button(screen, moveHereImage, 1.61, 16, moveButtonScale)
room17 = button3.Button(screen, moveHereImage, 1.22, 18, moveButtonScale)
room18 = button3.Button(screen, moveHereImage, 1.26, 3.5, moveButtonScale)
room19 = button3.Button(screen, moveHereImage, 1.22, 1.75, moveButtonScale)
room20 = button3.Button(screen, moveHereImage, 1.25, 1.32, moveButtonScale)
room21 = button3.Button(screen, moveHereImage, 1.28, 1.09, moveButtonScale)
room22 = button3.Button(screen, moveHereImage, 1.62, 1.21, moveButtonScale)
room23 = button3.Button(screen, moveHereImage, 2.23, 1.16, moveButtonScale)
room24 = button3.Button(screen, moveHereImage, 2.15, 1.52, moveButtonScale)
...
useCardButton = button3.Button(screen, useCardButtonImage, 2, 2, 0.5)
...
while True:
    ...
    # While the state is the board, draw the board    
    while (state == "board"):
        ...
        if nextTurnButton.drawButton(screen) == True:
            ...
            rooms3.roomsList[previousRoomIndex].room_count -= 1
            rooms3.roomsList[newRoomIndex].room_count += 1
        ...
        if killButton.drawButton(screen) == True:
            ...
            currentSightLines = rooms3.allSightLines[currentPlayerRoom]
            canKill = True
            ...
            for siteLineRoom in currentSightLines:
                ...
                if rooms3.roomsList[siteLineRoom].room_count > 0:
                    canKill = False
            ...
            if currentPlayerRoom == drLuckyRoom and canKill == True and rooms3.roomsList[drLuckyRoom].room_count == 2:
        ...
        if (movementAction == True):
            ...
            currentRoom = rooms3.allAdjacentRooms[playerList[turnOrder].room_index]
            ...
            for adjacentRoom in currentRoom:
                ...
                if roomButtonsList[adjacentRoom].drawButton(screen) == True:
                    ...
                    rooms3.roomsList[previousRoomIndex].room_count -= 1
                    rooms3.roomsList[adjacentRoom].room_count += 1
                    updateRoom(previousRoomIndex)
            ...
            if CardInPlay != None:  
                ...
                if roomButtonsList[CardInPlay.room_index].drawButton(screen) == True:
                    ...
                    rooms3.roomsList[previousRoomIndex].room_count -= 1
                    rooms3.roomsList[CardInPlay.room_index].room_count += 1
                    updateRoom(previousRoomIndex)
