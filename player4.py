...
class Player4:
    ...
    def updatePlayer4(self, room_index):
        ...
        self.player_x = (self.surface_W - Player4.player_width) // self.x
        self.player_y = (self.surface_L - Player4.player_height) // self.y
            
            
    def DrawPlayer4(self):
        
        pygame.draw.rect(self.surface, self.color, (self.player_x, self.player_y, Player4.player_width, Player4.player_height)) 